...
Years = {'Opened Investigations': "OpenedYear", 'Closed Investigations': "Closed Year", 'Opened and Closed Investigations': "ClosedYear"}
    ...
    for variable, label in Labels.items():
      if label == Selected_var:
         ...
         if Selected_graph == "Histogram":
           ...
           plt = PlotTime(Data[[variable, Years[variable]]], Labels[variable], variable, Years[Selected_Data])
           st.pyplot(plt)
