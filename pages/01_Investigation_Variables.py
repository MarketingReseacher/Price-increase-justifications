...
def PlotPie(df, var):
    ...
    df.groupby(var).size().plot(kind='pie', autopct=labeling, colors=["#C00000", '#FF9999', '#00CCCC', '#49D845', '#CCCC00', '#808080'], textprops={'fontsize': 4}, ax=ax1, labeldistance =1.3, pctdistance=1.7)
    label = Labels[var]
