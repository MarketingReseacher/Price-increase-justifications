...
st.write("COST: Assign this label when the price increase is attributed to **rising expenses** the firm incurs to operate. This includes any of the following: (1) labor, materials, fuel, packaging, freight, logistics, insurance, maintenance, (2) general operations, compliance costs, regulatory fees, or energy, or (3) macroeconomic financial pressures such as inflation, tariffs, or taxation")  

st.write("MARKET: Assign this label only if the justification is due to external **demand** or competitive dynamics. This includes: (1) increased usage, consumer demand, seasonal surges, or growth in user base, and/or (2) limited market-level **supply** or availability of the offering due to constrained supply by rivals, or high market uptake. Do not assign market if the statement only refers to upstream supply issues (e.g., chip shortages), general volatility, or unfavorable conditions. If the justification mentions shortages of inputs (e.g., chips, raw materials), this is a cost driver, not market.")

st.write("QUALITY: Assign this label only if the firm claims that the price increase is due to **improved customer-facing value**. This includes:  (1) added features, better service, more convenience, upgraded performance, expanded access, or premium offerings , (2) statements that frame the increase as necessary to maintain a high standard of quality, where the tone is clearly about preserving elevated value for the customer, (3) references to content improvements, product upgrades, or infrastructure expansion, when framed as increasing or sustaining customer value, or (4) investments in experience or innovation, if presented as a benefit to the customer. Do not assign quality if the explanation refers to costs of operations or business survival without framing them as customer-facing improvements. If the firm mentions increased expenses to deliver, maintain, or improve customer value, classify as Quality only, not 'Cost, quality'.")
