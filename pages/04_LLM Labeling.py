...
st.write("MARKET: Assign this label only if the justification is due to external demand or competitive dynamics. This includes: (1) increased usage, consumer demand, seasonal surges, or growth in user base, (2) limited availability of the firm’s own offerings `due to constrained supply by rivals, or high market uptake`, and (3) explicit or implied alignment with competitor prices, or reference to market rates. Do not assign market if the statement only refers to upstream supply issues (e.g., chip shortages), general volatility, or unfavorable conditions. If the justification mentions shortages of inputs (e.g., chips, raw materials), this is a cost driver, not market.")
