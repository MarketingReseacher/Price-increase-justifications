...
st.write("Cost justifications attribute the price increase to higher expenses incurred by the firm. These expenses may include various operational costs such as maintenance, insurance, labor, logistics, or compliance, and may stem from firm-specific factors or broad economic conditions such as inflation or tariffs. The justification emphasizes that the price increase reflects internal financial pressure, rather than changes in customer demand, competition, or customer value. Cost justifications may refer to past, present, or expected future cost increases, and may describe these increases in concrete (e.g., labor costs) or abstract terms (e.g., operational costs, inflation). A grocery store increasing the selling price of lettuce after buying it at a higher price, or a landlord increasing the rent to cover higher maintenance costs are prime examples of cost-justified price increases (Kahneman et al. 1986a)")

st.markdown("##### Market Justification")
st.write("Market justifications attribute the price increase to favorable changes in external market conditions—such as increased customer demand and/or reduced availability of comparable offerings from rivals. These justifications emphasize that the price increase is in response to broader competitive dynamics, rather than rising internal costs or product enhancements. The justification reflects an opportunity to raise prices safely due to increased demand (e.g., higher usage, seasonal spikes), a competitive supply gap (e.g., waitlists, reduced rival availability), or price alignment with competitors. Classic examples of market-justified price increases are a hardware store increasing the price of shovels the morning after a snowstorm, or an auto dealer increasing the price of popular waitlisted cars (Kahneman et al. 1986a, 1986b).")
