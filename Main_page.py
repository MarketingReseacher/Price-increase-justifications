...
st.write("This website is an open-access tool meant to enable researchers and managers to examine the characteristics of our data easily and interactively.")
