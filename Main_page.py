...
st.write("This website is an easy access tool designed by our research team, meant to enable researchers to examine the characteristics of our data easily and interactively.")
st.write("You can visit the **Investigations Variables** page to obtain graphical representations of the variables leading to the opening or closing of investigations.")
st.write("Visit the **Process Variables** page to obtain graphical representations of our process-time variables.")
st.write("Visit the **Recall Variables** page to obtain graphical representations of the variables pertaining to the outcomes of investigations (i.e., product recalls).")
